import {
  __extends
} from "./chunk-VH7CSYYO.js";
import {
  init_define_process_env
} from "./chunk-PQO7J4CM.js";
...
l.vnode = function(n2) {
  ...
  if ("string" == typeof t3) {
    for (var o2 in u3 = {}, e3) {
      var i3 = e3[o2];
      if (!("value" === o2 && "defaultValue" in e3 && null == i3 || $2 && "children" === o2 && "noscript" === t3)) {
        var l3 = o2.toLowerCase();
        "defaultValue" === o2 && "value" in e3 && null == e3.value ? o2 = "value" : "download" === o2 && true === i3 ? i3 = "" : "ondoubleclick" === l3 ? o2 = "ondblclick" : "onchange" !== l3 || "input" !== t3 && "textarea" !== t3 || q3(e3.type) ? "onfocus" === l3 ? o2 = "onfocusin" : "onblur" === l3 ? o2 = "onfocusout" : Z.test(o2) ? o2 = l3 : -1 === t3.indexOf("-") && H2.test(o2) ? o2 = o2.replace(Y, "-$&").toLowerCase() : null === i3 && (i3 = void 0) : l3 = o2 = "oninput", "oninput" === l3 && u3[o2 = l3] && (o2 = "oninputCapture"), u3[o2] = i3;
      }
    }
...
//# sourceMappingURL=chunk-ARANRLOF.js.map
