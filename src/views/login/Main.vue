        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
          ...
          >
            ...
            <div class="intro-x mt-8">
              <input type="text" class="intro-x login__input form-control py-3 px-4 block" placeholder="Username" v-model="username" />

              <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password" v-model="password" />
...
const login = async () => {
  ...
  try {
    const response = await axios.post("http://backend.septiyan.my.id:8080/api/v1/auth/login", {
